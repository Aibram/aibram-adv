          ...
          <div class="col-lg-4 col-md-4 col-xs-6 col-mb-12">
            <div class="widget">
              ...
              <ul class="mt-3 footer-social">
                <li>
                  <a class="facebook" href="{{getSettings('facebookLink','https:://facebook.com')}}"
                    ><i class="fa fa-facebook-f"></i
                  ></a>
                </li>
                <li>
                  <a class="twitter" href="{{getSettings('twitterLink','https:://twitter.com')}}"
                    ><i class="fa fa-twitter"></i
                  ></a>
                </li>
                <li>
                  <a class="linkedin" href="{{getSettings('linkedinLink','https:://linkedin.com')}}"
                    ><i class="fa fa-linkedin"></i
                  ></a>
                </li>
                <li>
                  <a class="google-plus" href="{{getSettings('googleLink')}}"
          ...
          <div class="col-lg-4 col-md-4 col-xs-6 col-mb-12">
            <div class="widget">
              ...
              <ul class="menu">
                ...
                <li><a href="{{route('frontend.categories')}}">- {{__('frontend.footer.categories')}}</a></li>
                <li><a href="{{route('frontend.ads')}}">- {{__('frontend.footer.ads')}} </a></li>
                <li><a href="{{route('frontend.contact')}}">- {{__('frontend.footer.contact')}}</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-xs-6 col-mb-12">
            <div class="widget">
              ...
              <ul class="contact-footer">
                ...
                <li>
                  ...
                  ><span
                    ><a href="#">{{__('frontend.footer.city')}} <br />
                      {{getSettings('location','لا يوجد')}}</a
                    ></span
                  >
                </li>
              </ul>
