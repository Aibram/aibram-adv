                                ...
                                <div class="col-12">
                                    <div class="featured-box dashboard d-flex justify-content-between align-items-center">
                                        <div class="d-flex">
                                            <div class="figure">
                                                <a href="{{route('frontend.ad.details',['slug'=>$ad->slug])}}">
                                                    <img class="img-fluid" src="{{$ad->photo}}" alt="{{$ad->title}}" style="width:220px;height:140px"/></a>
                                            </div>
                                        ...
                                        <div class="button pl-2">
                                            <a href="{{route('frontend.ad.edit',['id'=>$ad->id])}}" class="btn btn-common bordered font-size-14 py-2 px-2"><i
