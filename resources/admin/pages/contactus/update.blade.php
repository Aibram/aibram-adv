        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="kt-grid__item ">
                    ...
                    <form class="kt-form" action="{{route('admin.contactus.update',$data->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                <label class="col-form-label col-lg-2 col-sm-12">{{__('pages.contactus.columns.contacted')}}</label>
                                <input data-switch="true" type="checkbox" name="contacted" @if($data->contacted==1) checked @endif data-on-text="{{__('base.activated')}}" data-on-color="success" data-off-color="warning" data-off-text="{{__('base.deactivated')}}">
                            </div>
                        </div>
