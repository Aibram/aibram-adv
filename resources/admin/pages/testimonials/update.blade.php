        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="kt-grid__item ">
                    ...
                    <form class="kt-form" action="{{route('admin.testimonials.update',$data->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="job" class="form-control" value="{{$data->job}}">
                            </div>
                            <div class="form-group">
...
@section('custom_scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\TestimonialUpdate'); !!}
@endsection