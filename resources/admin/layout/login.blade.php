...
<head>
    ...
    <link href="{{asset('assets/vendors/general/perfect-sWcrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('assets/vendors/general/animate.css')}}" rel="stylesheet" type="text/css" />
                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title">Aibram</h3>
                        </div>
                        <form class="kt-form" action="{{route('admin.loginPost')}}" method="post">
                            @csrf
                            ...
                            <div class="row kt-login__extra">
                                <div class="col">
                                    <label class="kt-checkbox">
                                        <input type="checkbox" name="remember"> {{__('pages.login.remember_me')}}
                                        <span></span>
                                    </label>
                                </div>
...
{{--                                    <a href="javascript:;" id="kt_login_forgot" class="kt-login__link">Forget Password ?</a>--}}
                            ...
                            <div class="kt-login__actions">
                                <button id="kt_login_signin_submit" class="btn btn-brand btn-elevate kt-login__btn-primary" type="submit">{{__('pages.login.login')}}</button>
                            </div>
                        </form>
                    </div>
